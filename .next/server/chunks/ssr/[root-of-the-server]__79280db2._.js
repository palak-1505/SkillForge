...
async function generateQuiz() {
    ...
    const prompt = `
    Generate exactly 10 challenging technical interview questions for a ${user.industry} professional${user.skills?.length ? ` with expertise in ${user.skills.join(", ")}` : ""}.
    
    Each question must be multiple choice with 4 distinct options, a single correct answer, and a concise explanation.
    Focus on core concepts and advanced topics relevant to the user's profile.
  `;
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79280db2._.js.map