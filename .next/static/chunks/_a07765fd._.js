...
"[project]/actions/interview.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function saveQuizResult(questions, answers, score) {
    ...
    if (wrongAnswers.length > 0) {
        const wrongQuestionsText = wrongAnswers.map((q)=>'Question: "'.concat(q.question, '"\nCorrect Answer: "').concat(q.answer, '"\nUser Answer: "').concat(q.userAnswer, '"')).join("\n\n");
        const improvementPrompt = "\n    The user got the following ".concat(user.industry, " technical interview questions wrong:\n\n    ").concat(wrongQuestionsText, "\n\n    Based on these mistakes, provide a concise, specific improvement tip.\n    Focus on the knowledge gaps revealed by these wrong answers.\n    Keep the response under 2 sentences and make it encouraging.\n    Don't explicitly mention the mistakes, instead focus on what to learn/practice.\n  ");
        try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$interview$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/actions/interview.js [app-client] (ecmascript)");
...
//# sourceMappingURL=_a07765fd._.js.map